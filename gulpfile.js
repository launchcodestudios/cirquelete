...
// Create CSS bundle, using files from /build/
gulp.task('css-build-bundle', function () {
	return gulp.src([
...
// Delete everything and force full rebuild
gulp.task('delCssPartials', function () {
	return del(['build/css/tachyons.min.css',
		'build/css/bloodline.min.css',
		'build/css/custom.min.css']);
});
...
gulp.task('watch', function (cb) {
	gulp.watch('src/**/*.scss', gulp.series('sass-lint', 'sass-build', 'copy-files', 'delCssPartials', 'sass-notify'));
